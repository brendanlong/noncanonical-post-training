...
| [think-sft-standard](https://huggingface.co/datasets/brendanlong/noncanonical-post-training/tree/main/think-sft-standard), [think-step0125-standard](https://huggingface.co/datasets/brendanlong/noncanonical-post-training/tree/main/think-step0125-standard), [think-step0875-standard](https://huggingface.co/datasets/brendanlong/noncanonical-post-training/tree/main/think-step0875-standard), [rlzero-math-standard](https://huggingface.co/datasets/brendanlong/noncanonical-post-training/tree/main/rlzero-math-standard) | the four cells run at the fixed `standard` arm (temperature 0.6 / top-p 0.95) |
